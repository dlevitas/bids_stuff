...
for i in range(len(data_types)):
    if data_types[i] == "func":
        dic['descriptions'].append({"dataType": data_types[i], "modalityLabel": modality_labels[i], "customLabels": custom_labels[i], "criteria":{"SidecarFilename": sidecars[i]}})
    else:
        dic['descriptions'].append({"dataType": data_types[i], "modalityLabel": modality_labels[i], "criteria":{"SidecarFilename": sidecars[i]}})
